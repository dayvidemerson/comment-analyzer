...
RSpec.describe JsonPlaceHolder::User do
  describe '.all' do
    it 'returns all users' do
      VCR.use_cassette('json_place_holder/users/all') do
  ...
  describe '.find' do
    it 'returns a specific user by ID' do
      VCR.use_cassette('json_place_holder/users/find') do
    ...
    it 'raises error when user does not exist' do
      VCR.use_cassette('json_place_holder/users/find_not_found') do
  ...
  describe '.where' do
    it 'returns a user by username' do
      VCR.use_cassette('json_place_holder/users/where_username') do
    ...
    it 'returns empty array when no user is found' do
      VCR.use_cassette('json_place_holder/users/where_username_not_found') do
